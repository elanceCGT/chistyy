...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
                ...
                <div class="ibox-content">
					...
					?>
                        ...
                        <div class="form-group <?php echo $this->Form->isFieldError('password') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Password</label>
                            <div class="col-sm-10">
                            	<?php
							        echo $this->Form->input('User.password',array('type' => 'password',    'placeholder' => 'Password','class'=>'form-control','label' => false,'div' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
                        ...
                        <div class="hr-line-dashed"></div>
                            ...
                            <div class="col-sm-10">
                            	<?php
							        echo $this->Form->input('Cleaner.cleaner_name',array('type' => 'text',    'placeholder' => 'Cleaner Name','class'=>'form-control','label' => false,'div' => false,'required' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
                        ...
                        <div class="hr-line-dashed"></div>
												...
												<div class="form-group <?php echo $this->Form->isFieldError('cleaner_gender') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Gender</label>
                            <div class="col-sm-10">
                        ...
                        <div class="hr-line-dashed"></div>
												...
												<div class="form-group <?php echo $this->Form->isFieldError('dateofbirth') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Date Of Birth</label>
                            <div class="col-sm-10">
                        <?php echo $this->Form->input('Cleaner.cleaner_dateofbirth',array(
															'readonly' => true,
															'type' => 'text', 
                        ...
                        <div class="hr-line-dashed"></div>
												...
												<div class="form-group <?php echo $this->Form->isFieldError('cleaner_caontact_number') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Contact No.</label>
                            <div class="col-sm-10">
                            	<?php
							        echo $this->Form->input('Cleaner.cleaner_caontact_number',array('type' => 'text',    'placeholder' => 'Contact No','class'=>'form-control','label' => false,'div' => false,'required' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
                        ...
                        <div class="hr-line-dashed"></div>
												...
												<div class="form-group <?php echo $this->Form->isFieldError('cleaner_address') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Address</label>
                            <div class="col-sm-10">
                            	<?php
							        echo $this->Form->input('Cleaner.cleaner_address',array('type' => 'textarea',    'placeholder' => '','class'=>'form-control','label' => false,'div' => false,'required' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
                        ...
                        <div class="hr-line-dashed"></div>
												...
												<div class="form-group <?php echo $this->Form->isFieldError('cleaner_city') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">City</label>
                            <div class="col-sm-10">
                            	<?php
							        echo $this->Form->input('Cleaner.cleaner_city',array('type' => 'text',  'placeholder' => 'City','class'=>'form-control','label' => false,'div' => false,'required' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
                        ...
                        <div class="hr-line-dashed"></div>
												...
												<div class="form-group <?php echo $this->Form->isFieldError('cleaner_state') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">State</label>
                            <div class="col-sm-10">
                            	<?php
							        echo $this->Form->input('Cleaner.cleaner_state',array('type' => 'text',    'placeholder' => 'State','class'=>'form-control','label' => false,'div' => false,'required' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
                        ...
                        <div class="hr-line-dashed"></div>
												...
												<div class="form-group <?php echo $this->Form->isFieldError('cleaner_zip_code') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Zip</label>
                            <div class="col-sm-10">
                            	<?php
							        echo $this->Form->input('Cleaner.cleaner_zip_code',array('type' => 'text',    'placeholder' => 'Zip','class'=>'form-control','label' => false,'div' => false,'required' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
                        ...
                        <div class="hr-line-dashed"></div>
												    	...
												    	<?php
							        echo $this->Form->input('Cleaner.cleaner_lat',array('type' => 'hidden',    
											'required' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
    	...
    	<?php
							        echo $this->Form->input('Cleaner.cleaner_lng',array('type' => 'hidden',    
											'required' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
