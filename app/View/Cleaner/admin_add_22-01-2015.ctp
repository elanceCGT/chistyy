...
<?php //echo $category_service_link; exit;?>
            ...
            <div class="ibox float-e-margins">               
                ...
                <div class="ibox-content">
					...
					?>
                        ...
                        <div class="form-group <?php echo $this->Form->isFieldError('Cleaner.service_provider_id') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Service Provider</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group <?php echo $this->Form->isFieldError('Cleaner.service_id') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Service</label>
                            <div class="col-sm-10">
						...
						<div class="form-group <?php echo $this->Form->isFieldError('Cleaner.cleaner_name') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Cleaner Name</label>
                            <div class="col-sm-10">
						...
						<div class="form-group <?php echo $this->Form->isFieldError('Cleaner.cleaner_gender') ? "has-error" : "" ;?>">
                        ...
                        <div class="hr-line-dashed"></div>
							...
							<div class="form-group <?php echo $this->Form->isFieldError('Cleaner.cleaner_dateofbirth') ? "has-error" : "" ;?>">
                                <label class="col-sm-2 control-label">Date Of Birth</label>
                                <div class="col-sm-10">
                                <?php echo $this->Form->input('Cleaner.cleaner_dateofbirth',array('readonly' => true,'type' => 'text',  'value' => '', 'placeholder' => '',	 'class'=>'form-control', 'label' => false, 'div' => false, 'required' => false, 'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label')))); ?>
                            	</div>
                        </div>
                        <div class="hr-line-dashed"></div>
												
						<div class="form-group <?php echo $this->Form->isFieldError('Cleaner.cleaner_caontact_number') ? "has-error" : "" ;?>">
						...
						<div class="form-group <?php echo $this->Form->isFieldError('Cleaner.cleaner_address') ? "has-error" : "" ;?>">
						...
						<div class="form-group <?php echo $this->Form->isFieldError('Cleaner.cleaner_city') ? "has-error" : "" ;?>">
						...
						<div class="form-group <?php echo $this->Form->isFieldError('Cleaner.cleaner_state') ? "has-error" : "" ;?>">
						...
						<div class="form-group <?php echo $this->Form->isFieldError('Cleaner.cleaner_zip_code') ? "has-error" : "" ;?>">
                       ...
                       <?php echo $this->Form->input('Cleaner.cleaner_lng',array('type' => 'hidden', 'required' => false, 'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label')))); ?>

                        <?php echo $this->Form->input('Cleaner.category_id',array('type' => 'hidden','required' => false, 'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label')) ));  ?>
