        ...
        <div class="container">
          	<?php echo $this->Form->create('User' ,array("class" => "form-horizontal formAdmin"));?>
                ...
                <div class="form-group <?php echo $this->Form->isFieldError('password') ? "has-error" : "" ;?>">
                    ...
                    <div class="col-sm-10">
                        <?php echo $this->Form->input('User.password',array('autocomplete' => 'off', 'type' => 'password', 'value' => '', 'placeholder' => 'Password','class'=>'form-control','label' => false,'div' => false,'required' => false, 'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label')) ));
                        ?>
                    </div>
                </div>
                ...
                <div class="hr-line-dashed"></div>
                    ...
                    <div class="form-group <?php echo $this->Form->isFieldError('Cleaner.cleaner_dateofbirth') ? "has-error" : "" ;?>">
                        ...
                        <div class="col-sm-10">
                        <?php echo $this->Form->input('Cleaner.cleaner_dateofbirth',array('autocomplete' => 'off', 'readonly' => true,'type' => 'text', 'placeholder' => '',  'class'=>'form-control', 'label' => false, 'div' => false, 'required' => false, 'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label')))); ?>
                        </div>
                </div>
                <div class="hr-line-dashed"></div>
                ...
                <div class="hr-line-dashed"></div>
                <?php 
									echo $this->Form->input('Cleaner.id',array('type' => 'hidden', 'required' => false, 'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label')) ));
