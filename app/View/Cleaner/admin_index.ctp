...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$("#list").jqGrid({
			...
			datatype: "json",
			mtype: 'GET',
			colNames: ['S No','User Name', 'Cleaner Name', 'Gender', 'Active Date', 'Contact Number', 'Manage Services', 'Status', 'Edit', 'Delete'],
			colModel: [
				{name:'id',index:'id',width:2,align:'center',stype:'text',sorttype:'int',sortable:false}, 
				...
				{name: 'gender_cd', index: 'gender_cd', width: 2, align: 'left', stype: '', sortable: true},
				{name: 'active_dt', index: 'active_dt', width: 4, align: 'left', stype: '', sortable: true},
				{name: 'phone_no', index: 'phone_no', width: 6, align: 'left', stype: '', sortable: true},
				{name: 'manageservices', index: 'manageservices', width: 4, align: 'center', stype: 'text', sortable: false},
				{name: 'user_status', index: 'user_status', width: 2, align: 'center', stype: 'text', sortable: true},
				{name: 'edit', index: 'edit', width: 2, align: 'center', stype: '', sortable: false, search: false},
