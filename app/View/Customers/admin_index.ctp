<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-2">
    	<a style="margin-top:20px;" href="<?php echo $this->Html->url(array('controller' => 'customers', 'action' => 'admin_add')); ?>" class="btn btn-primary control-label pull-right">Add</a>
    </div>
</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$("#list").jqGrid({
			url: '<?php echo $this->Html->url(array("controller" => "Customers", "action" => "customerlist")); ?>',
			datatype: "json",
			mtype: 'GET',
			colNames: ['S No','User Name', 'customer_name', 'Gender', 'Date Of Birth', 'Contact', 'Status', 'Edit', 'Delete'],
			colModel: [
				{name:'id',index:'id',width:4,align:'center',stype:'text',sorttype:'int',sortable:false}, 
				{name: 'username', index: 'username', width: 16, align: 'left', stype: 'text', sortable: true},
				{name: 'customer_name', index: 'customer_name', width: 16, align: 'left', stype: '', sortable: true},
				{name: 'gender', index: 'gender', width: 4, align: 'left', stype: '', sortable: true},
				{name: 'customer_dateofbirth', index: 'customer_dateofbirth', width: 10, align: 'left', stype: '', sortable: true},
