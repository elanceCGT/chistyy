...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
                ...
                <div class="ibox-content">
					...
					?>
                        ...
                        <div class="form-group <?php echo $this->Form->isFieldError('password') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Password</label>
                            <div class="col-sm-10">
                            	<?php
							        echo $this->Form->input('User.password',array('type' => 'password', 'value' => '', 'placeholder' => 'Password','class'=>'form-control','label' => false,'div' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
                        ...
                        <div class="hr-line-dashed"></div>
												...
												<input type="hidden" name="data[User][user_type]" value="<?php echo $userType; ?>" /> 
                            ...
                            <div class="col-sm-10">
                            	<?php
							        echo $this->Form->input('Customer.customer_name',array('type' => 'text', 'value' => '', 'placeholder' => 'Customer Name','class'=>'form-control','label' => false,'div' => false,'required' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
                        ...
                        <div class="hr-line-dashed"></div>
                            ...
                            <div class="col-sm-10">
                            	<?php
							        echo $this->Form->input('Customer.customer_gender',array('type' => 'radio','class'=>'','label' => false,'div' => false,'required' => false,'options' => array('0' => '<label class="" > Male </label>', '1' => '<label class="" > Female </label>'),'before' => '', 'after' => '', 'between' => '', 'separator' => '<label class="" >&nbsp;&nbsp;&nbsp;</label>','legend' => false,
                                        'fieldset' => false, 'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))));
						...
						<div class="form-group <?php echo $this->Form->isFieldError('Customer.customer_number') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Contact No.</label>
                            <div class="col-sm-10">
                            	<?php
							        echo $this->Form->input('Customer.customer_number',array('type' => 'text', 'value' => '', 'placeholder' => 'Contact No','class'=>'form-control','label' => false,'div' => false,'required' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
						...
						<div class="form-group <?php echo $this->Form->isFieldError('Customer.customer_address') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Address</label>
                            <div class="col-sm-10">
                            	<?php
							        echo $this->Form->input('Customer.customer_address',array('type' => 'textarea', 'value' => '', 'placeholder' => '','class'=>'form-control','label' => false,'div' => false,'required' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
						...
						<div class="form-group <?php echo $this->Form->isFieldError('Customer.customer_city') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">City</label>
                            <div class="col-sm-10">
                            	<?php
							        echo $this->Form->input('Customer.customer_city',array('type' => 'text', 'value' => '', 'placeholder' => 'City','class'=>'form-control','label' => false,'div' => false,'required' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
						...
						<div class="form-group <?php echo $this->Form->isFieldError('Customer.customer_state') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">State</label>
                            <div class="col-sm-10">
                            	<?php
							        echo $this->Form->input('Customer.customer_state',array('type' => 'text', 'value' => '', 'placeholder' => 'State','class'=>'form-control','label' => false,'div' => false,'required' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
						...
						<div class="form-group <?php echo $this->Form->isFieldError('Customer.customer_zip_code') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Zip</label>
                            <div class="col-sm-10">
                            	<?php
							        echo $this->Form->input('Customer.customer_zip_code',array('type' => 'text', 'value' => '', 'placeholder' => 'Zip','class'=>'form-control','label' => false,'div' => false,'required' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
                        ...
                        <div class="hr-line-dashed"></div>
												    	...
												    	<?php
							        echo $this->Form->input('Customer.customer_lat',array('type' => 'hidden', 'value' => '', 
											'required' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
    	...
    	<?php
							        echo $this->Form->input('Customer.customer_lng',array('type' => 'hidden', 'value' => '', 
											'required' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
			...
			$( "#CustomerCustomerDateofbirth" ).datepicker(
                {
                    beforeShow: function(input, inst) { 
                        //console.log(input);
                        //console.log(inst);
                        //inst.dpDiv.css({"z-index":"999 !important"});
                        setTimeout(function(){
