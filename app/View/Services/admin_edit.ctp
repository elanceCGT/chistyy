                ...
                <div class="ibox-content">
                    ...
                    <?php echo $this->Form->create('Service' ,array("class" => "form-horizontal formAdmin")); ?>
                        ...
                        <div class="form-group <?php echo $this->Form->isFieldError('sub_category_id') ? "has-error" : "" ;?>">
                            ...
                            <div class="col-sm-10">
                                <?php echo $this->Form->input('sub_category_id',array('type' => 'select', 'class'=>'form-control', 'label' => false, 'div' => false, 'options' => $subcategory, 'required'=>true, 'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))));?>
                            </div>
                        </div>
