    ...
    <div class="row">
        <div class="col-lg-12">            
            <div class="ibox float-e-margins">  
                ...
                <div class="ibox-content">
                    ...
                    <?php
                        echo $this->Form->create('User' ,array("class" => "form-horizontal formAdmin", 'type' => 'file'));
                    ?>
                            ...
                            <div class="col-sm-10">
                                <?php
                                    echo $this->Form->input('User.username',array('type' => 'text','placeholder' => 'Username','class'=>'form-control','label' => false,'div' => false,'required' => true,
                        ...
                        <div class="form-group <?php echo $this->Form->isFieldError('User.password') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Password</label>
                            <div class="col-sm-10">
                                <?php
                                    echo $this->Form->input('User.password',array('type' => 'password', 'value' => '', 'placeholder' => 'Password','class'=>'form-control','label' => false,'div' => false,'required' => true,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
                        ...
                        <div class="form-group <?php echo $this->Form->isFieldError('confirm_password') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Confirm Password</label>
                            <div class="col-sm-10">
                                <?php
                                    echo $this->Form->input('confirm_password',array('type' => 'password', 'value' => '', 'placeholder' => 'Confirm Password','class'=>'form-control','label' => false,'div' => false,'required' => true,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
        ...
        <?php
                                 ...
                                 ?>
                                                ...
                                                <div class="form-group <?php echo $this->Form->isFieldError('ServiceProvider.provider_description') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Provider Description</label>
                            <div class="col-sm-10">
                                <?php
                        ...
                        <div class="hr-line-dashed"></div>
                                                ...
                                                <div class="form-group <?php echo $this->Form->isFieldError('ServiceProvider.provider_website') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Provider Website</label>
                            <div class="col-sm-10">
                                <?php
                        ...
                        <div class="hr-line-dashed"></div>
                                                ...
                                                <div class="form-group <?php echo $this->Form->isFieldError('ServiceProvider.provider_email_address') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Provider Email Address</label>
                            <div class="col-sm-10">
                                <?php
                        ...
                        <div class="hr-line-dashed"></div>
                                                ...
                                                <div class="form-group <?php echo $this->Form->isFieldError('ServiceProvider.provider_logo') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Provider Logo</label>
                            <div class="col-sm-10">
                                <?php
...
<script type="text/javascript">
    function goBack() {
        window.top.location = "<? echo $this->Html->url(array('controller'=>'serviceprovider','action' => 'admin_index',$userType), true); ?>"
    }
