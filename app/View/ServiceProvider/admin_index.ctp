...
<div id="dialog-confirm" title="Delete Customer?" style="display:none;">
  <p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Are you sure You want to Delete Customer?</p>
</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$("#list").jqGrid({
			...
			datatype: "json",
			mtype: 'GET',
			colNames: ['S No','User Name', 'Provider Name', 'Contact Name', 'Contact Number', 'Street Address', 'Provider Website', 'Provider Email', 'Status', 'Edit', 'Delete'],
			colModel: [
				...
				{name: 'Provider_name', index: 'Provider_name', width: 10, align: 'left', stype: '', sortable: true},
				{name: 'contactname', index: 'contactname', width: 10, align: 'left', stype: '', sortable: true},
				{name: 'customer_number', index: 'customer_number', width: 10, align: 'left', stype: '', sortable: true},
				{name: 'street_address', index: 'street_address', width: 10, align: 'left', stype: '', sortable: true},
				{name: 'provider_website', index: 'provider_website', width: 10, align: 'left', stype: '', sortable: true},
				{name: 'provider_email', index: 'provider_email', width: 10, align: 'left', stype: '', sortable: true},
				{name: 'status', index: 'status', width: 10, align: 'center', stype: 'text', sortable: true},
				{name: 'edit', index: 'edit', width: 10, align: 'center', stype: '', sortable: false, search: false},
