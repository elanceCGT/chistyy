                ...
                <div class="ibox-content">
					...
					<div class="form-group <?php echo $this->Form->isFieldError('User.username') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Username</label>
						...
						<div class="form-group <?php echo $this->Form->isFieldError('ServiceProvider.contact_name') ? "has-error" : "" ;?>">
                            ...
                            <div class="col-sm-10">
                            	<?php echo $this->Form->input('ServiceProvider.contact_name',array('type' => 'text',  'placeholder' => 'Contact Name','class'=>'form-control','label' => false,'div' => false,'required' => true,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
                                 ?>
                        	</div>
...
<script type="text/javascript">
    function goBack() {
        window.top.location = "<? echo $this->Html->url(array('controller'=>'serviceprovider','action' => 'admin_index'), true); ?>"
    }
