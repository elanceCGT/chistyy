            ...
            <div class="ibox float-e-margins">                
                ...
                <div class="ibox-content">
                	<div class="pull-right">
                    	<input type="button" class="btn btn-primary" onclick="window.location.href='<?php echo $this->Html->url(array("controller"=>"users","action" => "playeradd","admin" => true));?>'" value="Add Player">
                    </div>	 
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#list").jqGrid({
			url: '<?php echo $this->Html->url(array("controller" => "users", "action" => "admin_playergrid")); ?>',
			datatype	: "json",
            mtype		: "POST",
	...
	function editUser(id) {
		window.top.location = "<?php echo $this->Html->url(array('action' => 'admin_playeredit'), true); ?>/"+id;
	}
