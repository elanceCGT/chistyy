                ...
                <div class="ibox-content">
					...
					?>
                        ...
                        <div class="form-group <?php echo $this->Form->isFieldError('name_jpn') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Name JPN</label>
                            <div class="col-sm-10">
                            	<?php
							        echo $this->Form->input('name_jpn',array('type' => 'text','placeholder' => 'Name ','class'=>'form-control','label' => false,'div' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
                        ...
                        <div class="form-group <?php echo $this->Form->isFieldError('designation') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Designation</label>
                            <div class="col-sm-10">
                                <?php
                                    
                                    echo $this->Form->input('designation',array('type' => 'text','placeholder' => 'Designation','class'=>'form-control','label' => false,'div' => false,
                        ...
                        <div class="form-group <?php echo $this->Form->isFieldError('designation_jpn') ? "has-error" : "" ;?>"><label class="col-sm-2 control-label">Designation JPN</label>
                            <div class="col-sm-10">
                            	<?php
							        echo $this->Form->input('designation_jpn',array('type' => 'text', 'value' => '', 'placeholder' => 'Designation','class'=>'form-control','label' => false,'div' => false,
                                        'error' => array('attributes' => array('wrap' => 'span', 'class' => 'control-label'))
                                        ));
                        ...
                        <div class="form-group <?php echo $this->Form->isFieldError('designation_jpn') ? "has-error" : "" ;?>">
