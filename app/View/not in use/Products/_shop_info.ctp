<div class="col-md-5 col-sm-6 col-xs-12 premimum_pad2 pinD">
          <div class="shop_right">
            	<div class="lastcor">
                        ...
                        <div class="shoprightinput">
                            <input type="text" readonly="" value="<?php if(isset($shopData['Pin']['name']) && !empty($shopData['Pin']['name'])){ echo $shopData['Pin']['name']; } else { echo "Shop Title"; }  ?>" placeholder="Puma Tokyo" class="shoprighttextbox">
